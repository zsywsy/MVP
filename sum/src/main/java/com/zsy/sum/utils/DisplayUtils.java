...
//        final ViewTreeObserver.OnGlobalLayoutListener ogll = null;

//        ogll = new ViewTreeObserver.OnGlobalLayoutListener() {
//            @Override
//            public void onGlobalLayout() {
//                ApiVsnHelper.runAccordingToApi(16, new ApiVsnHelper.ApiVsnCall() {
//
//                    @Override
//                    public void lowRun() {
//                        view.getViewTreeObserver().removeGlobalOnLayoutListener(ogll);
//                    }
//
//                    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
//                    @Override
//                    public void highRun() {
//                        view.getViewTreeObserver().removeOnGlobalLayoutListener(ogll);
//                    }
//                });
//            }
//        };
...
//
//        Log.i("LgTag", "treeOb" + view.getWidth() + ":" + view.getHeight());
//
    }
